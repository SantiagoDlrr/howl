...
const NavDropdown = ({ session, isLandingPage = false, isScrolled = false }: NavDropdownProps) => {
    ...
    const getMenuButtonClasses = (isSignOut: boolean = false) => {
        const baseClasses = "w-full text-left px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3";
